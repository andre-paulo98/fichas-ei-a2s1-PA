...
struct gengetopt_args_info
{
  ...
  int num_procs_arg;	/**< @brief number.  */
  char * num_procs_orig;	/**< @brief number original value given at command line.  */
  const char *num_procs_help; /**< @brief number help description.  */
